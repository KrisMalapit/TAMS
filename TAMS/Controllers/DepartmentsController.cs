...
namespace TAMS.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(TAMSContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Departments.Where(a => a.Status == "Active").ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name")] Department department)
        {
            if (ModelState.IsValid)
            {
                ...
                Log log = new Log
                {
                    Descriptions = "Add Departments - " + department.Id,
                    Action = "Add",
                    Status = "success",
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name")] Department department)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    Log log = new Log
                    {
                        Descriptions = "Edit Departments - " + department.Id,
                        Action = "Edit",
                        Status = "success",
                        UserId = User.Identity.Name
                    };
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            Log log = new Log
            {
                Descriptions = "Delete Departments - " + id,
                Action = "Delete",
                Status = "success",
                UserId = User.Identity.Name
            };
